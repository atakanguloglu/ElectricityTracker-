...
import { Button, Avatar, Dropdown, Badge, Tooltip, Space, Typography, App } from 'antd'
import { 
  LogoutOutlined,
  UserOutlined,
  SettingOutlined,
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  useEffect(() => {
    ...
    if (!isSuperAdmin()) {
      message.error('Bu sayfaya erişim yetkiniz yok. SuperAdmin yetkisi gereklidir.')
      router.push('/login')
      return
    }
  ...
  const userMenuItems = [
    ...
    },
    {
      ...
      onClick: () => router.push('/super-admin/account-settings')
    },
    {
      key: 'help',
      icon: <QuestionCircleOutlined />,
      label: 'Yardım & Destek',
      onClick: () => router.push('/super-admin/help')
    },
    {
    ...
    <div className="admin-layout-container">
      ...
      >
        <ProLayout
          ...
          headerTitleRender={(logo, title) => (
            <div className="header-title">
              ...
              <div className="title-content">
                <h1 className="main-title">SuperAdmin Panel</h1>
          ...
          onMenuHeaderClick={() => router.push('/super-admin')}
            ...
            <Space className="header-user-info" size={16}>
              <div className="user-info-content">
                ...
                <div className="user-role-wrapper">
                  ...
                  <Text className="user-role">SuperAdmin</Text>
                </div>
              </div>
            </Space>
          )}
