...
export default function AccountSettingsPage() {
  ...
  const handleSave = async (values: AccountSettingsFormValues) => {
    setLoading(true)
    try {
      // Simulate API call
      ...
      <Tabs defaultActiveKey="security" size="large">
        ...
        >
          <Row gutter={[24, 24]}>
            ...
            <Col xs={24} lg={8}>
              <ProCard title="Güvenlik Ayarları" extra={<SafetyOutlined />}>
        ...
        >
          <Row gutter={[24, 24]}>
            <Col xs={24} lg={16}>
              <ProCard title="Veri Gizliliği" extra={<SafetyOutlined />}>
                <Space direction="vertical" style={{ width: '100%' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
